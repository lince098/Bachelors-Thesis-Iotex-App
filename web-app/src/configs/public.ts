  ...
  CONTRATO_ABI_NO_STRING: [
    ...
    },
    {
      ...
      outputs: [
        ...
        { internalType: "uint256", name: "plazoEncendido", type: "uint256" },
        {
          internalType: "enum PistasDePadelGestion.Estado",
          name: "estado",
          type: "uint8",
        },
      ],
    ...
    {
      inputs: [
        { internalType: "uint256", name: "idPista", type: "uint256" },
        { internalType: "uint256", name: "minutos", type: "uint256" },
      ],
      name: "reservar",
      outputs: [],
    ...
    {
      inputs: [
        { internalType: "uint256[]", name: "_idReset", type: "uint256[]" },
      ],
      name: "resetearPlazos",
      outputs: [],
      stateMutability: "nonpayable",
    ...
    {
      inputs: [{ internalType: "uint256", name: "idPista", type: "uint256" }],
      name: "setPistaApagado",
      outputs: [],
      stateMutability: "nonpayable",
      type: "function",
    },
    ...
    {
      inputs: [{ internalType: "uint256", name: "idPista", type: "uint256" }],
      name: "setPistaFuncionamiento",
      outputs: [],
      stateMutability: "nonpayable",
      type: "function",
    },
    {
      inputs: [{ internalType: "uint256", name: "_precio", type: "uint256" }],
      name: "setPrecioXMinuto",
      outputs: [],
      stateMutability: "nonpayable",
      type: "function",
    },
    {
      inputs: [{ internalType: "uint256", name: "segundos", type: "uint256" }],
      name: "setTiempoExtra",
      outputs: [],
      stateMutability: "nonpayable",
      type: "function",
